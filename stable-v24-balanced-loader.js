...
const replacements=[
  ...
  ["function rewardLen(len){return len===2?2:len===3?3:len===4?4:len>=6?7:6}","function rewardLen(len){return len===2?1:len===3?2:len===4?3:len===5?4:5}"],
  ...
  ["coins+=cfg().reward;ammo+=zone<3?3:5;","coins+=cfg().reward;const zBonus=N<=7?3:N<=11?4:5;ammo+=zBonus;"],
